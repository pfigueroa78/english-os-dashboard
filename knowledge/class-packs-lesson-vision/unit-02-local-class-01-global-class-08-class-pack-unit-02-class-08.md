# CLASS_PACK_UNIT_02_CLASS_08

Filename retrieval key: unit-02-local-class-01-global-class-08-class-pack-unit-02-class-08.md
Exact retrieval key: CLASS_PACK_UNIT_02_CLASS_08
Unit retrieval key: UNIT_02
Local class retrieval key: UNIT_02_LOCAL_CLASS_01
Global class retrieval key: GLOBAL_CLASS_8
Book pages retrieval key: BOOK_PAGES_10_11
PDF pages retrieval key: PDF_PAGES_19_20
...
- Active class PDF pages: 19-20
- Active class section names: Starting point + Listening + Grammar + Discussion
- Active class grammar focus: past modals and phrasal modals of obligation; should have; was supposed to; had to; didn't have to; was/were supposed to; needed to
- Active class vocabulary focus: life lessons; learning the hard way; bad decisions; mistakes; messes; math test; uniform; trendy outfits; dorm room; microwave; cafeteria; unprepared; broke; got caught; Company picnic; Harbor View Court apartments
- Active class functions: talk about mistakes and consequences; explain what someone should have done; listen for a bad decision and why it was bad; describe past obligations and lack of obligation; discuss past experiences
- Active class target structures: I was supposed to...; I didn't have to...; I should have...; We weren't supposed to...; I really shouldn't have...; I had to...; I needed to...
- Expected learner production: describe one past mistake or past experience and say what should have been done differently using past modals or phrasal modals of obligation
...
- Global English OS class: 8
- Lesson type: Student Book class
- Lesson title: Life lessons
- Book pages: 10-11
- PDF pages: 19-20
- Notes: Includes Starting point, Listening, Grammar, and Discussion across PDF pages 19-20.

Teacher retrieval instruction:
Use this class pack as the primary source when the learner asks for Unit 2, Class 1, or English OS Class 8. Teach the content as a live class, not as a dump.

## Extracted Student Book content

## PDF_PAGE 19 | BOOK_PAGE 10
PDF_PAGE: 19
BOOK_PAGE: 10
