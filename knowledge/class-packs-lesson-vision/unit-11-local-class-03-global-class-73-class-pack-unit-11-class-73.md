# CLASS_PACK_UNIT_11_CLASS_73

Filename retrieval key: unit-11-local-class-03-global-class-73-class-pack-unit-11-class-73.md
Exact retrieval key: CLASS_PACK_UNIT_11_CLASS_73
Unit retrieval key: UNIT_11
Local class retrieval key: UNIT_11_LOCAL_CLASS_03
Global class retrieval key: GLOBAL_CLASS_73
...
- Active class: Unit 11, local class 3, global class 73
- Lesson title: Unit 11 Grammar Plus
...
- Active class grammar focus: Consolidate the grammar from the previous Unit 11 lesson block using only confirmed course/index context.
- Active class vocabulary focus: Recycle Unit 11 vocabulary already confirmed in indexed class packs.
...
Aliases: CLASS_PACK_UNIT_11_CLASS_73 | UNIT_11_LOCAL_CLASS_03 | GLOBAL_CLASS_73 | UNIT_11_CLASS_73 | UNIT_11_CLASS_3_LOCAL | PDF_PAGE_RANGE_NONE | BOOK_PAGE_RANGE_NONE

Metadata:
- Unit: 11
- Local class inside unit: 3
- Global English OS class: 73
...
Use this class pack as the primary source when the learner asks for Unit 11, Class 3, or English OS Class 73. Teach the content as a live class, not as a dump.
