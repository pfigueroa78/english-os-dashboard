...
- Do not include the evaluation gate, recap, achievement, weakness, correction priority, next action, approval, or session-log language in this opening turn.
- Continue with the next active section only after the learner answers.
- Present the evaluation gate only after the learner has practised the active sections.
